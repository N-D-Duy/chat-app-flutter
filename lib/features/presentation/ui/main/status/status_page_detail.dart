...
import 'package:chat_app_flutter/features/presentation/ui/main/status/components/custom_story_item.dart';
...
class StatusDetailPage extends StatefulWidget {
  ...
  const StatusDetailPage(
      {Key? key, required this.status, required this.isMyStatus})
      : super(key: key);
