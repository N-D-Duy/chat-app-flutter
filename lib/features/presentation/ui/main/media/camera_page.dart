...
import 'package:chat_app_flutter/features/presentation/ui/main/media/widget/appbar/camera_app_bar.dart';
...
import 'package:chat_app_flutter/features/presentation/widgets/custom_timer_count_up.dart';
...
class CameraPage extends StatefulWidget {
  ...
  const CameraPage(
      {Key? key, this.receiverId, this.userData, required this.isGroupChat})
      : super(key: key);
